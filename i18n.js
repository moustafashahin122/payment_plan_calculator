const I18N = {
  en: {
    ...
    modeForward: 'Forward (cash → plan)',
    modeReverse: 'Reverse (plan → cash)',
    cashValue: 'Cash Value',
    totalPaidInput: 'Total Paid',
    cashValueComputed: 'Cash Value (computed)',
    totalPaidInputTip: 'The total nominal amount the buyer will pay across the down payment, all installments, and any custom payments. The calculator works backward to find the equivalent cash value at the chosen discount rate.',
    sensitivityTitle: 'Cash Value Sensitivity (±10% around chosen rate)',
    sensitivityHint: "If you're not sure of the exact discount rate, scan how the cash value changes for each whole-percent rate around your input.",
    rate: 'Rate',
    deltaVsTotal: 'Δ vs Total Paid',
  ...
  ar: {
    ...
    modeForward: 'من القيمة النقدية إلى الخطة',
    modeReverse: 'من الخطة إلى القيمة النقدية',
    cashValue: 'القيمة النقدية',
    totalPaidInput: 'إجمالي المدفوع',
    cashValueComputed: 'القيمة النقدية (محسوبة)',
    totalPaidInputTip: 'إجمالي المبلغ الاسمي الذي سيدفعه المشتري عبر الدفعة المقدمة وجميع الأقساط والدفعات المخصصة. تعمل الحاسبة بشكل عكسي لإيجاد القيمة النقدية المعادلة عند معدل الخصم المختار.',
    sensitivityTitle: 'حساسية القيمة النقدية (±10% حول المعدل المختار)',
    sensitivityHint: 'إذا لم تكن متأكدًا من معدل الخصم الدقيق، يمكنك مراجعة كيف تتغير القيمة النقدية لكل نسبة مئوية حول المعدل المُدخل.',
    rate: 'المعدل',
    deltaVsTotal: 'الفرق عن الإجمالي المدفوع',
